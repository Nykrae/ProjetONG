...
function twentythirteen_setup() {
	...
	add_theme_support( 'post-formats', array(
		'aside', 'audio', 'chat', 'gallery', 'image', 'link', 'quote', 'status', 'video', 'fiche'
	) );
...
function wpc_champs_personnalises_defaut($post_id)
 {
	 ...
	 add_post_meta($post_id, 'nom', '', true);
	 add_post_meta($post_id, 'type', '', true);
	 add_post_meta($post_id, 'race', '', true);
	 add_post_meta($post_id, 'sexe', '', true);
	 add_post_meta($post_id, 'age', '', true);
	 add_post_meta($post_id, 'caractère', '', true);
	 }
 	return true;
 }
